...
const KOLOM: { atas: string; bawah?: string; kelas?: string; lebar: number }[] = [
  ...
  { atas: "Sales Group", lebar: 5.4 },
  { atas: "No. Kontrak", lebar: 5 },
  { atas: "Tgl. Kontrak", lebar: 4.5 },
  { atas: "Unit", lebar: 4 },
  { atas: "Nama Konsumen", lebar: 5 },
  { atas: "Marketing", lebar: 6 },
  ...
  { atas: "Skema Cara Bayar", lebar: 4.5 },
  { atas: "Status", bawah: "Unit", lebar: 3 },
  { atas: "Status", bawah: "Tgl. Batal", lebar: 4 },
  { atas: "Type", lebar: 2.6 },
  { atas: "Arah Hadap", lebar: 2.8 },
  { atas: "Nilai Kontrak", bawah: "(Include PPN)", kelas: "angka", lebar: 5 },
  { atas: "Nilai Kontrak", bawah: "(Exclude PPN)", kelas: "angka", lebar: 5 },
  { atas: "DPP Nilai Lain", kelas: "angka", lebar: 5 },
  { atas: "Penerimaan", bawah: "Rp.", kelas: "angka", lebar: 5 },
